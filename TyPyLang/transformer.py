...
class TyPyTransformer(ast.NodeTransformer):
    def visit_FunctionDef(self, node):
        # Если функция имеет аннотации параметров или возвращаемого значения, добавляем декоратор type_checked
    ...
    def visit_AnnAssign(self, node):
        # Преобразуем присваивание с аннотацией (например, x: int = expr) в вызов __type_check__
